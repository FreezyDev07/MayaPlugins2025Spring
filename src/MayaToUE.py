...
class MayaToUE:
    ...
    def SendToUnreal(self):
        ...
        mc.FBXExportSmoothGroups("-v", True)
    ...
    ueUtilPath = os.path.join(sprunger.srcDir, "UnrealUtils.py")
    ...
    commandLines = []
    with open(ueUtilPath, 'r') as ueUtiltyFile:
        commandLines = ueUtiltyFile.readlines()
